    ...
    <div id="info">
        <div class="container">
            ...
            <div class="body">
                ...
                <form id="signupForm" action="joinInsert.php" method="post" name="joinForm">

                    <div class="insert">
                        <div class="id">
                            <input maxlength="20" id="emailId" class="" type="text" name="emailId" placeholder="아이디(이메일)">
                            <input maxlength="20" id="emailHost" class="" type="text" style="width:126px;" name="emailHost" placeholder="">
                        ...
                        <div class="pwd">
                            ...
                            <p class="frt">6~15자의 영문, 숫자, 특수문자 조합</p>
                        </div>
                        <div class="name">
                            <input maxlength="20" id="name" class="name" type="text" name="name" placeholder="이름">
                        </div>
                        <div class="date">
                        ...
                        <div class="address">
                            ...
                            <input type="button" name="zipSearchbtn" id="zipSearchbtn" value="우편검색" style="vertical-align: middle;width: 100px; height: 34px;border: 1px solid #333;background-color: #fff; color:#333 ;line-height: 32px;">
                            <p></p>
                        ...
                        <div class="phone">
                            ...
                            <input maxlength="4" id="phone2" class="" type="text" name="phone2" placeholder="">
                            <input maxlength="4" id="phone3" class="" type="text" name="phone3" placeholder="">
                        </div>
                    </div>
                    <input class="joinButton btn_s_gray btn_205" type="submit" id="btn4" value="회원가입" style="margin-top:10px">
                </form>
                <button class="joinButton btn_s_red btn_205" id="btn5" onclick="location.href='join1.php'">처음으로</button>
                </button>
