...
<div id="login" class="jn_login">
		<div class="jn_container">
			<div class="jn_head">
				...
				<ul>
					<li style="border-bottom: 1px solid rgb(0, 0, 0);color: rgb(0, 0, 0);">
						<a href="idfind.php">아이디찾기</a>
					</li>
					<li style="border-bottom: 0px; color: rgb(170, 170, 170);">
			...
			<div class="jn_body">
				<div class="jn_findId">
					<div class="jn_enter">
						...
						<input class="jn_userNm" type="text" id="userNm" name="userNm" placeholder="이름">

						<div class="phone">
							
							<select name="phoneLeft" id="phoneLeft" class="jn_phoneLeft">
							...
							<input class="jn_phoneCenter" type="text" name="phoneCenter"  placeholder="">
							<input class="jn_phoneRight" type="text" name="phoneRight"  placeholder="">
					...
					<script>
						...
						$(document).ready(function () {
							...
							$('#idFind').click(function (e) {
								...
								iphone = $('#phoneLeft').val() + $('#phoneCenter').val() + $('#phoneRight').val();
								$.ajax({
									type: 'POST',
									url: 'findId.php',
									data: {
