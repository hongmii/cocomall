...
<script>
    ...
    function insertCart(div, uid, pid, pqn, ppr){
        ...
        alert();
        $.ajax({
            url: "cartProc.php?mem_id=$mem_id",
            type: "post",
            ...
            <div class="items">
                <ul class="fl">
                    ...
                    <li class="fl item_con">
                            <div class="img">
                                <a href="/product/product_detail.php?prod_id=<?=$prod_id?>">
...
?>
        ...
        <div class="list_cnt">
            <ul class="inline list_cnt_ul">
                <li class="inlineB nowPage">
                <!-- S: 페이징 num -->
 <?
                    //페이지리스트 첫번째 페이지 구하기 
                    ...
                    for($i = $start_page; $i <= $end_page; $i++){
                        ...
                        echo "<a href=\"$PHP_SELF?no=$page&field=$field&sword=$sword\">";
                        echo "$page_num ";
                        echo "</a>";
                    }
