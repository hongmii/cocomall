    ...
    <div id="contentWrap">
            ...
            <table class="main_menu_box">
                <thead>
                    <tr >
                        ...
                        <th class="hm_th1" style="text-align: center;"><a href="cs_01.php">1:1문의</a></th>
                    </tr>
                </thead>
            </table>
        ...
        ?>
            <tr style="border-bottom:1px solid #e3e3e3; font-size: 13px;" >
                ...
                <td class="Tcol2" style="width:700px; height:41px;"><a href="cs_notice_read.php?id=<?= $nb_seq ?>"><?= $nb_title ?></a></td>
