...
<head>
    <meta charset="utf-8" />
    <link rel="stylesheet" type="text/css" media="screen" href="cs_oftenq.css" />
                ...
                <table class="main_menu_box">
                    <thead>
                        <tr>
                            ...
                            <th class="th1" style="text-align:center;"><a href="cs_01.php">1:1문의</a></th>
                        </tr>
                    </thead>
                </table>
                    ...
                    <div id="faqTable">
                        <table class="tableContent">
                            ...
                            <tr>
                                ...
                                <td class="col3"><a href="oftenq_read.php">반품/교환 접수를 했는데 회수기사가 오지않아요</a></td>
                            </tr>
                            <tr>
                                <td class="col1">12</td>
                                <td class="col2">배송/반품/교환/AS</td>
                                <td class="col3"><a href="oftenq_read.php">사은품을 반품하고 싶어요</a></td>
                            </tr>
                            <tr>
                                <td class="col1">11</td>
                                <td class="col2">배송/반품/교환/AS</td>
                                <td class="col3"><a href="oftenq_read.php">상품을 반품하고 싶어요</a></td>
                            </tr>
                            <tr>
                                <td class="col1">10</td>
                                <td class="col2">배송/반품/교환/AS</td>
                                <td class="col3"><a href="oftenq_read.php">다른 상품이 왔어요</a></td>
                            </tr>
                            <tr>
                                <td class="col1">9</td>
                                <td class="col2">배송/반품/교환/AS</td>
                                <td class="col3"><a href="oftenq_read.php">상품을 교환하고 싶어요</a></td>
                            </tr>
                            <tr>
                                <td class="col1">8</td>
                                <td class="col2">배송/반품/교환/AS</td>
                                <td class="col3"><a href="oftenq_read.php">회수기사가 상품을 가져갔는데 교환 환불은 언제되나요?</a></td>
                            </tr>
                            <tr>
                                <td class="col1">7</td>
                                <td class="col2">배송/반품/교환/AS</td>
                                <td class="col3"><a href="oftenq_read.php">배송을 받지 못했는데 배송완료가 되어있어요</a></td>
                            </tr>
                            <tr>
                                <td class="col1">6</td>
                                <td class="col2">배송/반품/교환/AS</td>
                                <td class="col3"><a href="oftenq_read.php">현재의 배송상태를 알고싶어요</a></td>
                            </tr>
                            <tr>
                                <td class="col1">5</td>
                                <td class="col2">배송/반품/교환/AS</td>
                                <td class="col3"><a href="oftenq_read.php">배송비는 얼마인가요?</a></td>
                            </tr>
                            <tr>
                                <td class="col1">4</td>
                                <td class="col2">배송/반품/교환/AS</td>
                                <td class="col3"><a href="oftenq_read.php">주문한 상품의 배송은 언제쯤오나요?</a></td>
                            </tr>
                        </table>
