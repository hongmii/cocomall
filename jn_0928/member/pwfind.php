                ...
                <div class="container">
                    ...
                    <div class="body">
                        <div class="findId" style="display: none;">
                            <div class="enter">
                                <input class="customerNm"type="text" name="userNm"placeholder="이름">
                                <div class="phone">
                                ...
                                <option value="019">019</option>
                                    ...
                                    <input class="phoneCenter"type="text" name="phoneCenter"placeholder="">
                                    <input class="phoneRight"type="text" name="phoneRight"placeholder="">
                            ...
                            <button class="send btn_s_red btn_240" onclick="sendSms()">
                                ID 찾기
                            </button>		
                            <div class="buttonDiv1">
                                <button class="send btn_s_gray btn_205" onclick="sendSms()">
                                    인증번호 전송
                                </button>
                                <button class="send btn_s_red btn_205" onclick="checkAuthNo()">
                                    확인
                                </button>				
                            </div>
                            <div class="buttonDiv2">
                                <button class="send btn_s_gray btn_205" onclick="location.href='/account/join/intro.do'">
                                    회원가입 하기
                                </button>
                                <button class="send btn_s_red btn_205" onclick="sendSms()">
                                    인증번호 전송
                                </button>				
                            </div>
        
                                <button class="buttonDiv3 btn_s_red btn_240" onclick="location.href='/account/login.do'">
                                    로그인
                                </button>			
        
                        </div>
                        <div class="findPwd" style="display:block;" center=80%>
                            <div>
                                <ul>
                                ...
                                <div class="enter">
                                    ...
                                    <input class="email"type="text" style="width:126px;" name="email" placeholder="">
                                    <select id="selectEmail" name="email" class="frt">
                                ...
                                <button class="buttonDiv3 btn_s_red btn_240" style="left:50%;" onclick="sendSms2()">
