...
<tbody>
    ...
    <tr>
        ...
        <td class="tdb2">
            <textarea name="message" rows="10" cols="101" required></textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="tdb5">
         ...
         <input type="checkbox" value="terms" required>이메일 답변수신<br>
        </td>
    </tr>
    <tr>
 </tr>
 ...
 <input type="reset" value="취소" id="btn1" >  <input type="submit" value="Submit" id="btn2" >
</form>   
</center>
</body>
</html>