...
<body>
        <div id="login" class="jn6_login" style="margin-top:50px; margin-bottom:100px;">
                <div class="jn6_container">
                    ...
                    <div class="jn6_body">
                        ...
                        <div class="jn6_findPwd" style="display:block;" center=80%>
                            <div>
                                <ul class="jn6_ul">
                                    <li class="jn6_li">∙ 비밀번호의 경우 암호화 저장되어 분실 시 찾아드릴 수 없는 정보입니다.</li>
                                    <li class="jn6_li">∙ 본인확인을 통해 비밀번호를 재설정 하실 수 있습니다.</li>						
                                </ul>
                                <div class=".jn6_enter">
                                    <input class="jn6_customerNm"type="text" name="userNm"placeholder="이름">
