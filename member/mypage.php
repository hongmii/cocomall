...
<body>
	<div id="jn4_content" class="jn4_size1200">

			
			<h2 class="jn4_cont_h2tit01 jn4_eng" style="margin-bottom: 20px;">마이 페이지</a></h2>
			<!-- <div class="bgBox"> -->
			
			
		
				<div class="jn4_myInfo">
					<div class="jn4_gradeArea" id="gradeArea"><strong class="silver">SILVER 등급</strong>
					
					<div class="jn4_itemArea">
						<div class="jn4_pointArea">
							<strong>POINT</strong>
							<!-- <em>포인트</em> -->
							<p class="count" id="pointArea" class="num"><?= $row['mem_pt'] ?><span class="eng">P</span></p>
						</div>
						<div class="jn4_couponArea">
							<strong>COUPON</strong>
							<em>쿠폰</em>
							<p class="count" id="couponArea" class="num">23<span class="kor">장</span></p>
						</div>
					</div>
				</div>
				</div>
...
<!-- .division -->
		...
		<div class="jn4_division">
			<div class="jn4_lnb">
                    <dl>
                            <dt class="jn4_dt"><a href="./changeInfo.php">나의 정보관리</a></dt>
				...
				<div class="jn4_cont">
				<h3 class="jn4_h3">최근 주문 상품<a href="/mypage/orderList" class="btnMore bgNo">more</a></h3>
				<!-- .deliveryPrd -->
				<div class="jn4_deliveryPrd">
					<!-- .tbl -->
					<div class="tbl tblBasic">
						<table class="jn4_head" summary="배송 중 상품 목록">
							...
							<thead>
								<tr class="jn4_tr">
									<th class="jn4_th" scope="col">상품정보</th>
									<th class="jn4_th" scope="col">결제금액</th>
									<th class="jn4_th" scope="col">진행상태</th>
								</tr>
							</thead>
							<tbody>
...
<?
            ...
            ?>								</tbody>
                ...
                <!-- <h3>최근 주문 상품<a href="/mypage/orderList" class="btnMore bgNo">more</a></h3> -->
                    ...
                    <br>
					<div class="jn4_cont">
	                    <h3 class="jn4_h3">위시리스트<a href="../mypage/getProductWishList" class="btnMore bgNo">more</a></h3>
