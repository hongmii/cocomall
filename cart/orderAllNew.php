<?
    ...
    $getOrders_query = "SELECT COUNT(*)
                        FROM cart
                        WHERE mem_id = '$_SESSION[mem_id]'";
    $rs2 = mysql_query($getOrders_query, $conn);
    ...
    $insert_query = "INSERT INTO orders (mem_id, order_tel, order_addr1, order_addr2)
                    VALUES ('$_SESSION[mem_id]', '$mem_tel', '$mem_addr1', '$mem_addr2')";
    ...
    $insertOrderDt_query = "INSERT INTO order_detail (order_id, product_id, orderDt_qt, orderDt_price, orderDt_st, orderDt_paid)
                            SELECT $row6[0], p.prod_id, c.cart_qt, p.prod_pr, 0, 0 FROM cart c, product_list p
...
<body>
    <section id="center">
        ...
        <div class="order_status_box">
            ...
            <div class="or_sum">
                <? $calcShipping= ($total > 30000)? 0: $shipping;
                    echo number_format($calcShipping); ?>원
                <br>
            </div>
            <div class="icon_sum">
                <span></span>
            ...
            <div class="or_sum">
                <? echo ($total  > 30000)?  number_format($total-$save) :number_format($total-$save+$shipping) ?>원
                <br>
            </div>
        </div>
        ...
        <ul class="bulList">
            <li>
                총 상품금액이 30,000원 이상이므로 배송비는 무료입니다.
            </li>
        </ul>
...
<form action="orderPaid.php" method=-"GET">
        ...
        <h4 class="Info_text">배송지 정보
            <div class="checkbox" id="sameInfo" onclick="sameInfo()">
        ...
        <table class="deliveryInfo">
            ...
            <tr>
                ...
                <td colspan="3" class="">
                    <div class="textbox">
                        <input type="text" placeholder="&nbsp;&nbsp;배송메세지를 입력해주세요." name="msg" style="height: 25px; width: 768px;">
        ...
        <table class="nohead">
            <tr>
                ...
                <th>포인트</th>
                <td>
                    <input type="text" class="pointTxt" style="height: 25px; width: 138px; text-align:right" value=<?= $row1['mem_pt'] ?> readonly>&nbsp; P
                </td>
        ...
        <!-- <div class="sumArea">
            ...
            <div class="sum_result">
                <!--sum_result start-->
                <dl class="sum_cont">
                    <dt class="dt"><input type="checkbox" id="usePntCheckbox" style="margin-right:10px;">포인트 사용 (1000P 이상 사용 가능)</dt>
                    <dd class="dd">
